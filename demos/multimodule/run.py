...
Run with:
    uv run martian project.py
    uv run martian serve
"""

import martianbook as martian

from demos.multimodule.modules.ingestor   import load_csv, validate_schema
from demos.multimodule.modules.processor  import clean, engineer_features, _debug_print_sample
from demos.multimodule.modules.visualizer import plot_value_distribution, plot_feature_correlation
